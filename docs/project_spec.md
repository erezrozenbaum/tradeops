...
As of version **3.34.0**, TradeOps AI is a full Personal Financial Intelligence Platform with Decision Intelligence, Behavioral Alpha, and execution tooling. See `CHANGELOG.md` for the complete version history.

**Current platform capabilities (v3.34.0):**
